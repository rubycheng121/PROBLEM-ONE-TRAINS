...
Problem:  The local commuter railroad services a number of cities in Taiwan.  Because of the mountainous local geography, all of the tracks are 'one-way.' 
That is, a route from Kaoshiung to Taipei does not imply the existence of a route from Taipei to Kaoshiung.  In fact, even if both of these routes do happen to exist, they are distinct and are not necessarily the same distance as the tracks may have to go over different terrain!
